...
#define OTA_EXTENDED_PACKET_LEN 1
...
#define MAX_NUMBER_ATTRIBUTES_RECORDS_SERVICE_1 (18)
...
#define ATT_VALUE_ARRAY_SIZE    (49 + 23 + 25 + 21 + 180 + 106  + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 70 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Gyroscope (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28), Pressure (29)  characteristics)  Services
#else
#define ATT_VALUE_ARRAY_SIZE    (49 + 23 + 25 + 21 + 180 + 106 + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 70 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Gyroscope (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28) , Pressure (29), Humidity (28) characteristics)  Services
#endif 
